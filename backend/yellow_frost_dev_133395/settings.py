"""
Django settings for yellow_frost_dev_133395 project.
...
ROOT_URLCONF = 'yellow_frost_dev_133395.urls'
...
WSGI_APPLICATION = 'yellow_frost_dev_133395.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yellow_frost_dev_133395 API",
    "DESCRIPTION": "API documentation for yellow_frost_dev_133395 App",
    "VERSION": "v1",
}
